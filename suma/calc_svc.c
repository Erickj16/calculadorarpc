...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, cal, calc_ver, cal_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (cal, calc_ver, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, cal, calc_ver, cal_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (cal, calc_ver, tcp).");
		exit(1);
	}
